	<?php
		if (isset($_REQUEST['edit'])) {
			...
			//jika mengubah file		
				$query 	= "UPDATE surat_masuk SET no_agenda='$no_agenda', no_surat='$no_surat', jenis_surat='$jenis_surat', tanggal_surat='$tanggal_surat', asal_surat='$asal_surat', isi_ringkas='$isi_ringkas', file='$file' WHERE id='$_GET[id]'";
				$sql   	= mysqli_query($connect, $query);
				if ($sql) {
